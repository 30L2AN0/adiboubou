...
top = Tk()
C = Canvas(top,height = 600, width = 1200, background = "#f12344")

C.pack()
top.title("Anne is stone")


image_anne = ImageTk.PhotoImage(Image.open("anne.png").resize((taille,taille), Image.ANTIALIAS), master = top)
image_blue_anne = ImageTk.PhotoImage(Image.open("blue_anne.png").resize((taille,taille), Image.ANTIALIAS), master = top)
image_wall = ImageTk.PhotoImage(Image.open("wall2.png").resize((taille,taille), Image.ANTIALIAS), master = top)
image_grass = ImageTk.PhotoImage(Image.open("grass2.png").resize((taille,taille), Image.ANTIALIAS), master = top)
image_bad_champi = ImageTk.PhotoImage(Image.open("bad_champi.png").resize((taille,taille), Image.ANTIALIAS), master = top)
image_good_champi = ImageTk.PhotoImage(Image.open("champi.png").resize((taille,taille), Image.ANTIALIAS), master = top)
image_auriane = ImageTk.PhotoImage(Image.open("auriane.png").resize((taille,taille), Image.ANTIALIAS), master = top)
image_blue_auriane = ImageTk.PhotoImage(Image.open("blue_auriane.png").resize((taille,taille), Image.ANTIALIAS), master = top)
image_blue_bad_champi = ImageTk.PhotoImage(Image.open("blue_bad_champi.png").resize((taille,taille), Image.ANTIALIAS), master = top)
image_blue_wall = ImageTk.PhotoImage(Image.open("blue_wall.png").resize((taille,taille), Image.ANTIALIAS), master = top)
image_DUH = ImageTk.PhotoImage(Image.open("DUH.png").resize((1200,600), Image.ANTIALIAS), master = top)
image_good_champi_anne = ImageTk.PhotoImage(Image.open("good_champi_anne.png").resize((taille,taille), Image.ANTIALIAS), master = top)
image_real_blue_grass = ImageTk.PhotoImage(Image.open("real_blue_grass.png").resize((taille,taille), Image.ANTIALIAS), master = top)
image_victory = ImageTk.PhotoImage(Image.open("victory.png").resize((1200,600), Image.ANTIALIAS), master = top)

def update_grille(l1,l2):
    nouv_grille = [[None for j in range(600//taille)] for i in range(1200//taille)]
